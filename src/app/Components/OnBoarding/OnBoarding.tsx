...
<div className="max-w-[530px] px-[40px] py-[32px] flex flex-col justify-between gap-[30px] rounded-[16px] bg-white shadow-lg">
        <div className="flex flex-col">
          ...
          <div className='w-full flex gap-[20px]'>
            <Image className='rounded-full w-[64px] h-[64px]' src={'https://static-00.iconduck.com/assets.00/profile-user-icon-2048x2048-m41rxkoe.png'} alt='' width={100} height={100} />
            ...
            <div className='flex flex-col gap-[16px]'>
                ...
                <label className='py-[8px] px-[16px] border border-[#9393B7] rounded-[8px] w-fit cursor-pointer' htmlFor="image">
